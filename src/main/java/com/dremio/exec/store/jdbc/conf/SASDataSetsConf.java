...
@SourceType(value = "SASDataSetsARP", label = "SASDataSets",uiConfig = "sasdatasets-layout.json")
public class SASDataSetsConf extends AbstractArpConf<SASDataSetsConf> {
  private static final String ARP_FILENAME = "arp/implementation/sasdatasets-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.sasdatasets.SASDataSetsDriver";
